...
insert into "ml"."owner"("code","name", "is_deleted") values('OWNER','TEST OWNER', false);
insert into "ml"."job_owner"("owner_code", "job_id") values ('OWNER', 1);

insert into "ml"."owner_marketplace"("owner_code",   "source", "host", "client_id", "password")
